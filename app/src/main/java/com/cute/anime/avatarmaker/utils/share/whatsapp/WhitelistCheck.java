package com.cute.anime.avatarmaker.utils.share.whatsapp;
...
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.cute.anime.avatarmaker.utils.share.whatsapp.StickerContentProvider";
