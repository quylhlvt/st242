package com.cute.anime.avatarmaker.custom
...
import com.cute.anime.avatarmaker.custom.listener.listenerdraw.BitmapDrawIcon
import com.cute.anime.avatarmaker.custom.listener.listenerdraw.DeleteEvent
import com.cute.anime.avatarmaker.custom.listener.listenerdraw.EditEvent
import com.cute.anime.avatarmaker.custom.listener.listenerdraw.FlipEvent
import com.cute.anime.avatarmaker.custom.listener.listenerdraw.OnDrawListener
import com.cute.anime.avatarmaker.custom.listener.listenerdraw.ZoomEvent
import com.cute.anime.avatarmaker.utils.DataHelper.dpToPx
...
open class DrawView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    private val borderDrawable: Drawable? by lazy {
        try {
            ContextCompat.getDrawable(context, R.drawable.drawnew)
        } catch (e: Exception) {
            null
        }
    }
    // Thêm biến ở đầu class
    private var borderBitmap: Bitmap? = null
    private var lastBorderSize = Pair(0, 0)
    @IntDef(
