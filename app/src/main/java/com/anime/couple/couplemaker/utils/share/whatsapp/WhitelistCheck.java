package com.anime.couple.couplemaker.utils.share.whatsapp;
...
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.anime.couple.couplemaker.utils.share.whatsapp.StickerContentProvider";
